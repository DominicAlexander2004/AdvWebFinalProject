            ...
            <div class="col-md-4 text-md-end">
                <div class="d-flex gap-3 justify-content-md-end justify-content-center">
                    <div class="stats-card">
                        ...
                        <div class="h4 mb-0">{{ $cars->total() }}</div>
                ...
                <div class="row g-3">
                        ...
                        <div class="row g-2">
                            <div class="col-6">
                                ...
                                <input type="date" class="form-control" id="start_date" name="start_date" 
                                    value="{{ request('start_date') }}" min="{{ $minStartDate }}" required>
                            ...
                            <div class="col-6">
                                ...
                                <input type="date" class="form-control" id="end_date" name="end_date" 
                                    value="{{ request('end_date') }}" min="{{ $minStartDate }}" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="d-flex gap-2 justify-content-end">
                            ...
                            <a href="{{ route('cars.index') }}" class="btn btn-reset text-white">
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <form action="{{ route('bookings.store') }}" method="POST" id="bookingForm">
                    @csrf
                    <input type="hidden" name="start_date" value="{{ request('start_date') }}" id="bookingStartDate">
                    <input type="hidden" name="end_date" value="{{ request('end_date') }}" id="bookingEndDate">
                                ...
                                <div class="card car-card">
                                    ...
                                    <div class="card-body p-3">
                                        ...
                                        <div class="car-detail">
                                            ...
                                            <span class="fw-semibold">{{ ucfirst($car->type) }}</span>
                                        </div>
                                        <div class="car-detail">
                                            <span><i class="fas fa-cog"></i> Transmission:</span>
                                            <span class="fw-semibold">{{ ucfirst($car->transmission) }}</span>
                                        </div>
                                        <div class="car-detail">
                                            <span><i class="fas fa-building"></i> Branch:</span>
                                            <span class="fw-semibold">{{ $car->branch->location }}</span>
                                        </div>
                                        <div class="car-detail mb-3">
                                            <span><i class="fas fa-money-bill"></i> Daily Rate:</span>
                                            <span class="car-price">RM{{ number_format($car->daily_rate, 2) }}</span>
                                        </div>

                                        <div class="form-check mb-3">
                                            <input class="form-check-input car-checkbox" type="checkbox" 
                                                name="car_ids[]" value="{{ $car->id }}" id="car-{{ $car->id }}">
                                            <label class="form-check-label fw-semibold" for="car-{{ $car->id }}">
                                                Select this car
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-footer bg-transparent border-0 p-3 pt-0">
                                        <button type="button" class="btn btn-outline-primary w-100" 
                                            data-bs-toggle="modal" data-bs-target="#carModal-{{ $car->id }}">
                                    ...
                                    <div class="modal-content">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <table class="table table-borderless">
                                                        ...
                                                        <tr><th>Type:</th><td>{{ ucfirst($car->type) }}</td></tr>
                                                    </table>
                                                </div>
                                                <div class="col-md-6">
                                                    <table class="table table-borderless">
                                                        <tr><th>Transmission:</th><td>{{ ucfirst($car->transmission) }}</td></tr>
                                                        <tr><th>Color:</th><td>{{ ucfirst($car->color) }}</td></tr>
                                                        <tr><th>Daily Rate:</th><td class="text-success fw-bold">RM{{ number_format($car->daily_rate, 2) }}</td></tr>
                                                        <tr><th>Branch:</th><td>{{ $car->branch->name }} ({{ $car->branch->location }})</td></tr>
                                                    </table>
                                                </div>
                                            </div>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="button" class="btn btn-primary select-car-btn" 
                                                data-car-id="{{ $car->id }}" data-bs-dismiss="modal">
