            ...
            <div class="col-md-3 col-lg-2 d-md-block bg-white sidebar">
                <div class="d-flex flex-column p-3">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo e(route('admin.cars')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.cars*') ? 'active' : ''); ?>">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo e(route('admin.staff')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.staff*') ? 'active' : ''); ?>">
...
</html><?php /**PATH C:\xampp\htdocs\ece-rental\resources\views/layouts/admin.blade.php ENDPATH**/ ?>