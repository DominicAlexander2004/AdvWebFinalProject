    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-md-4 text-md-end">
                <a href="<?php echo e(route('cars.index')); ?>" class="btn btn-browse">
...
<div class="container">
    ...
    <?php if($bookings->isEmpty()): ?>
        <div class="empty-state">
            ...
            <a href="<?php echo e(route('cars.index')); ?>" class="btn-browse">
    ...
    <?php else: ?>
        ...
        <div class="stats-grid">
            <div class="stats-card">
                ...
                <div class="stats-number"><?php echo e($bookings->count()); ?></div>
                <div class="stats-label">Total Bookings</div>
            </div>
            <div class="stats-card">
                <i class="fas fa-clock stats-icon pending"></i>
                <div class="stats-number"><?php echo e($bookings->where('status', 'pending')->count()); ?></div>
                <div class="stats-label">Pending</div>
            </div>
            <div class="stats-card">
                <i class="fas fa-check-circle stats-icon approved"></i>
                <div class="stats-number"><?php echo e($bookings->where('status', 'approved')->count()); ?></div>
        ...
        <?php $__currentLoopData = $bookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="booking-card">
                <div class="booking-header">
                    <div class="row align-items-center">
                        <div class="col-md-6">
                            <h5 class="booking-id">Booking #<?php echo e($booking->id); ?></h5>
                            <div class="booking-date">
                                <i class="fas fa-calendar me-1"></i>
                                Booked on <?php echo e($booking->created_at->format('d M Y, h:i A')); ?>
                ...
                <div class="card-body p-4">
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="rental-period">
                                ...
                                <div class="rental-dates">
                                    <?php echo e($booking->start_date->format('d M Y')); ?>
                                ...
                                <div class="rental-duration">
                                    <?php echo e($booking->getTotalDaysAttribute()); ?> day<?php echo e($booking->getTotalDaysAttribute() > 1 ? 's' : ''); ?>
                        ...
                        <div class="col-lg-5">
                            ...
                            <?php $__currentLoopData = $booking->cars; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $car): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="car-item">
                                    <div class="car-name"><?php echo e($car->brand); ?> <?php echo e($car->model); ?></div>
                                    <small class="text-muted">
                                        <i class="fas fa-building me-1"></i><?php echo e($car->branch->location); ?>

                                        <span class="mx-2">•</span>
                                        <i class="fas fa-cog me-1"></i><?php echo e(ucfirst($car->transmission)); ?>

                                        <span class="mx-2">•</span>
                                        <i class="fas fa-money-bill me-1"></i>RM<?php echo e(number_format($car->daily_rate, 2)); ?>/day
                                    </small>
                                </div>
                        ...
                        <div class="col-lg-3">
                            <div class="total-amount">
                                ...
                                <div style="font-size: 1.5rem;">
                                    RM<?php echo e(number_format($booking->total_amount ?: $booking->calculateTotalAmount(), 2)); ?>
                        ...
                        <div class="booking-timeline">
                            <div class="timeline-item">
                                <div class="timeline-content">
                                    <strong>Booking Submitted</strong> - <?php echo e($booking->created_at->format('d M Y, h:i A')); ?>
                    ...
                    <?php if($booking->status === 'rejected' && $booking->notes): ?>
                        <div class="booking-notes">
                            <strong><i class="fas fa-info-circle me-2"></i>Rejection Reason:</strong>
                            <p class="mb-0 mt-2"><?php echo e($booking->notes); ?></p>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ece-rental\resources\views/bookings/index.blade.php ENDPATH**/ ?>