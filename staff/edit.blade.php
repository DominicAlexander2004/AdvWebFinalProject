...
<div class="card">
    <div class="card-header bg-white d-flex justify-content-between align-items-center">
        <h5 class="mb-0">Edit Staff Account: {{ $user->name }}</h5>
        ...
        <form action="{{ route('admin.staff.update', $user->id) }}" method="POST">
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <div class="form-text">Leave blank to keep the current password. New password must be at least 8 characters long.</div>
                    @error('password')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
